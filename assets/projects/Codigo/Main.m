...
while true % repetir até obter indicação para terminar 
	prompt = strcat('Menu', ENTER, ' A - Seleccionar ficheiro de dados', ENTER, ' B – Correr Algoritmo', ENTER,  ' T - Terminar o programa', ENTER, 'Escolha uma opcao:');
	txt = input(prompt, 's');
	...
	switch choice
		  ...
		  case 'B'
              ...
              if executouLerDados == false
                  ...
                  %disp('Atenção: o Algoritmo não está disponível.');
                  Heuristica;
              end
